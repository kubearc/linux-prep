...
### Question 16: Configure Application
User albert login message:
Welcome to the EX200 Exam

### Question 17: Creating a Container Image
User Andrew builds image watcherimage

### Question 18: Container as Service
Create my-watcher container as systemd service

## NODE 2

### Question 1: Password Break
Reset root password to redhat

### Question 2: Yum Repository Configuration
Configure BaseOS and AppStream repos

### Question 3: Set Tuning Profile
Apply recommended tuning profile

### Question 4: Create Swap
Create 250MB swap persistent

### Question 5: Create LVM
VG myvol, LV mydatabase, mount /database

### Question 6: Resize LVM
Resize home LV to 150MiB
